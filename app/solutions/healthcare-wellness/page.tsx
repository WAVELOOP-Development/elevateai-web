          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl  text-center lg:text-left text-muted-foreground mb-8 leading-relaxed">
                Transform your retail business with intelligent AI solutions
                that automate product management, enhance customer service, and
                boost sales through data-driven insights.
              </p>
              <Button
                size="lg"
                className="text-lg px-8 py-6 w-fit m-auto flex lg:m-0"
                asChild
              >
            ...
            <Card className="text-center">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground text-sm">
                  Automate repetitive tasks and free up your team for strategic
                  work.
                </p>
              </CardContent>
            </Card>
